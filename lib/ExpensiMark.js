...
export default class ExpensiMark {
    ...
    /**
     * Ensures that emails within italics markdown are replaced correctly, to account for
     * emails that begin in an underscore (_example@test.com is a valid email).
     *
